...
_TABLE_RULES: dict[str, _TableRule] = {
    ...
    "campaign_session_closeouts": _TableRule("session_history", "campaign"),
    "campaign_session_closeout_items": _TableRule("session_history", "campaign"),
...
_EXPECTED_COLUMNS: dict[str, tuple[str, ...]] = {
    ...
    "campaign_session_closeout_items": ("closeout_id", "campaign_slug", "item_key", "status", "note"),
    "campaign_session_closeouts": ("id", "campaign_slug", "session_id", "status", "revision", "created_at", "created_by_user_id", "updated_at", "updated_by_user_id", "completed_at", "completed_by_user_id"),
