...
BOOK_CHAPTER_IMPORT_TARGETS_BY_SOURCE = {
    ...
    # Random Encounters, Traps Revisited, Downtime Revisited, Awarding Magic
    # Items, and Shared Campaigns sections now ship as their own source-backed
    # pages.
    "XGE": (
        ...
        ("Dungeon Master's Tools", "Tool Proficiencies"),
        ("Dungeon Master's Tools", "Spellcasting"),
        ...
        ("Dungeon Master's Tools", "Awarding Magic Items"),
        "Shared Campaigns",
    ...
    # wrapper while the broader MTF wrapper/subsystem follow-ups stay queued.
    "MTF": (
