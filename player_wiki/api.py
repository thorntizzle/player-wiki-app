...
from .character_advanced_editor_api_routes import (
    CharacterAdvancedEditorApiDependencies,
    register_character_advanced_editor_api_routes,
)
from .character_retraining_api_routes import (
...
from .character_xianxia_manual_import_api_routes import (
...
from .character_xianxia_dao_use_record_api_routes import (
    CharacterXianxiaDaoUseRecordApiDependencies,
...
from .character_xianxia_inventory_item_update_api_routes import (
    CharacterXianxiaInventoryItemUpdateApiDependencies,
    register_character_xianxia_inventory_item_update_api_route,
)
from .character_xianxia_inventory_item_remove_api_routes import (
...
from .character_currency_api_routes import (
...
def register_api(app) -> None:
    ...
    register_character_advanced_editor_api_routes(
        ...
        dependencies=CharacterAdvancedEditorApiDependencies(
            ...
            load_character_advanced_editor_target=load_character_advanced_editor_target,
            character_advanced_editor_is_supported=character_advanced_editor_is_supported,
            build_character_advanced_editor_parts=build_character_advanced_editor_parts,
            serialize_character_advanced_editor_response=serialize_character_advanced_editor_response,
            json_error=json_error,
            load_json_object=load_json_object,
            normalize_character_editor_values=normalize_character_editor_values,
            ...
            apply_native_character_edits=lambda *args, **kwargs: apply_native_character_edits(
                *args, **kwargs
            ),
    ...
    register_character_retraining_api_routes(
        ...
        dependencies=CharacterRetrainingApiDependencies(
            api_campaign_scope_access_required=api_campaign_scope_access_required,
            api_login_required=api_login_required,
            load_character_retraining_target=load_character_retraining_target,
            normalize_character_retraining_values=normalize_character_retraining_values,
            character_retraining_availability=character_retraining_availability,
            serialize_character_retraining_response=serialize_character_retraining_response,
            character_retraining_is_supported=character_retraining_is_supported,
            json_error=json_error,
            load_json_object=load_json_object,
            build_character_retraining_context_parts=build_character_retraining_context_parts,
            load_character_record=lambda campaign_slug, character_slug: load_character_record(
                campaign_slug, character_slug
            ),
            finalize_character_definition_for_write=lambda campaign_slug, definition: (
    ...
    register_admin_api_routes(
        ...
        dependencies=AdminApiDependencies(
            api_login_required=api_login_required,
            api_admin_required=api_admin_required,
            jsonify=lambda *args, **kwargs: jsonify(*args, **kwargs),
            abort=lambda *args, **kwargs: abort(*args, **kwargs),
            build_admin_dashboard_context=lambda: build_admin_dashboard_context(),
            require_admin_target_user=lambda user_id: require_admin_target_user(user_id),
            build_admin_user_detail_context=lambda user: build_admin_user_detail_context(
                user
            ),
            get_auth_store=lambda: get_auth_store(),
            load_json_object=load_json_object,
            ...
            get_current_user=lambda: get_current_user(),
            build_admin_local_url=build_admin_local_url,
            build_campaign_lookup=build_campaign_lookup,
            get_character_repository=lambda: get_character_repository(),
            serialize_user=serialize_user,
        ),
    )
    ...
    register_character_xianxia_manual_import_api_routes(
        ...
        dependencies=CharacterXianxiaManualImportApiDependencies(
            ...
            build_xianxia_manual_import_context=lambda *args, **kwargs: build_xianxia_manual_import_context(
                *args, **kwargs
            ),
            build_xianxia_manual_import_payload=lambda values: build_xianxia_manual_import_payload(
                values
            ),
            build_xianxia_manual_import_character=lambda *args, **kwargs: build_xianxia_manual_import_character(
                *args, **kwargs
            ),
            validate_character_slug=lambda character_slug: validate_character_slug(
                character_slug
            ),
            build_xianxia_manual_import_preview=lambda *args, **kwargs: build_xianxia_manual_import_preview(
                *args, **kwargs
            ),
        ),
    )
    ...
    register_character_controls_assignment_api_routes(
        ...
        dependencies=CharacterControlsAssignmentApiDependencies(
            ...
            load_json_object=load_json_object,
            get_auth_store=lambda: get_auth_store(),
            serialize_character_controls_response=serialize_character_controls_response,
        ),
    )
    ...
    register_character_vitals_api_route(
        ...
        dependencies=CharacterVitalsApiDependencies(
            ...
            run_character_mutation=run_character_mutation,
            get_character_state_service=get_character_state_service,
            optional_json_hit_dice_current=lambda *args, **kwargs: optional_json_hit_dice_current(
                *args, **kwargs
            ),
        ),
    )
    ...
    register_character_xianxia_dao_use_record_api_route(
        ...
        dependencies=CharacterXianxiaDaoUseRecordApiDependencies(
            api_login_required=api_login_required,
            can_manage_campaign_session=lambda *args, **kwargs: can_manage_campaign_session(
                *args, **kwargs
            ),
            json_error=json_error,
            run_character_definition_mutation=run_character_definition_mutation,
            ensure_xianxia_character_definition=ensure_xianxia_character_definition,
            required_json_int=required_json_int,
            json_payload_value=json_payload_value,
            managed_character_import_metadata=managed_character_import_metadata,
            record_xianxia_dao_immolating_use_definition=lambda *args, **kwargs: record_xianxia_dao_immolating_use_definition(
                *args, **kwargs
            ),
        ),
    )
