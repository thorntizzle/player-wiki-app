...
- `apps/api/tests/smoke.mjs`:
  - starts compiled API on a local port and verifies `/healthz`, app state, campaign list/detail, wiki home, wiki section, wiki page, image metadata, and 404 behavior.
