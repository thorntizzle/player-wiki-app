...
- Xianxia native creation, Cultivation/advancement, and Dao Immolating use-request/recording remain browser workflows in v1. Session-state JSON coverage now includes active Stance/Aura and modeled inventory add/edit/remove/equip because Gen2 Session Character consumes those same durable write paths.
