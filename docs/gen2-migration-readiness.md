...
- Keep visual/layout parity moving before any redirect decision; the current functional surface backlog is complete for the active Gen2 roadmap, and Combat is the next recommended visual target.
