...
- The validator never contacts Fly or mounts real app data. On this host, static checks are current evidence; an engine-backed build/run remains unverified until Docker Desktop is running and the runtime action succeeds.
