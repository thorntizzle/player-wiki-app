          ...
          <article className="character-summary">
            ...
            {isReadSurface && detailRecord ? (
              <div className="button-row character-action-row">
                ...
                {detailLinks.flask_progression_repair_url ? (
                  <a className="button button-secondary" href={detailLinks.flask_progression_repair_url}>
                    Progression repair
                  </a>
                ) : null}
                ...
                <span className="meta">Retraining and repair stay in Flask for now.</span>
              </div>
            ) : null}
            {canManagePortrait ? (
