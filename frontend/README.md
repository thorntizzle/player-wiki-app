...
- Characters roster, character read/edit shell, native create/import lanes, portrait controls, and Controls assignment/delete
...
Flask remains the source of truth for workflows that are still Flask-first, including Advanced Editor, Cultivation, level-up, retraining, progression repair, Admin, shared/core Systems entry editing, and Systems imports.
