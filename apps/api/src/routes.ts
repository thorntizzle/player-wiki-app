...
export const ROUTES = {
  ...
  campaignList: IMPLEMENTED_ROUTES[20].honoPath,
  appState: IMPLEMENTED_ROUTES[21].honoPath,
  systemsImportRuns: IMPLEMENTED_ROUTES[22].honoPath,
  systemsImportRun: IMPLEMENTED_ROUTES[23].honoPath,
} as const;
