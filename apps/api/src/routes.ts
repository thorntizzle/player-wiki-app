...
export const ROUTES = {
  ...
  campaignList: IMPLEMENTED_ROUTES[15].honoPath,
  appState: IMPLEMENTED_ROUTES[16].honoPath,
  systemsImportRuns: IMPLEMENTED_ROUTES[17].honoPath,
  systemsImportRun: IMPLEMENTED_ROUTES[18].honoPath,
} as const;
