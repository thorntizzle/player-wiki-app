...
export const ROUTES = {
  ...
  systemsIndex: IMPLEMENTED_ROUTES[14].honoPath,
  systemsSearch: IMPLEMENTED_ROUTES[15].honoPath,
  systemsSources: IMPLEMENTED_ROUTES[16].honoPath,
  systemsSourceDetail: IMPLEMENTED_ROUTES[17].honoPath,
  systemsSourceCategory: IMPLEMENTED_ROUTES[18].honoPath,
  systemsEntryDetail: IMPLEMENTED_ROUTES[19].honoPath,
  combatSystemsMonsterSearch: IMPLEMENTED_ROUTES[20].honoPath,
  combatState: IMPLEMENTED_ROUTES[21].honoPath,
  combatLiveState: IMPLEMENTED_ROUTES[22].honoPath,
  campaignList: IMPLEMENTED_ROUTES[23].honoPath,
  appState: IMPLEMENTED_ROUTES[24].honoPath,
  systemsImportRuns: IMPLEMENTED_ROUTES[25].honoPath,
  systemsImportRun: IMPLEMENTED_ROUTES[26].honoPath,
} as const;
