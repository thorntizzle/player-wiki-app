...
export const ROUTES = {
  ...
  campaignHelp: IMPLEMENTED_ROUTES[6].honoPath,
  campaignConfig: IMPLEMENTED_ROUTES[7].honoPath,
  contentPages: IMPLEMENTED_ROUTES[8].honoPath,
  contentAssets: IMPLEMENTED_ROUTES[9].honoPath,
  contentAsset: IMPLEMENTED_ROUTES[10].honoPath,
  contentPage: IMPLEMENTED_ROUTES[11].honoPath,
  contentCharacters: IMPLEMENTED_ROUTES[12].honoPath,
