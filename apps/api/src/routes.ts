...
export const ROUTES = {
  ...
  campaignList: IMPLEMENTED_ROUTES[16].honoPath,
  appState: IMPLEMENTED_ROUTES[17].honoPath,
  systemsImportRuns: IMPLEMENTED_ROUTES[18].honoPath,
  systemsImportRun: IMPLEMENTED_ROUTES[19].honoPath,
} as const;
