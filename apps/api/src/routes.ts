...
export const ROUTES = {
  ...
  campaignList: IMPLEMENTED_ROUTES[21].honoPath,
  appState: IMPLEMENTED_ROUTES[22].honoPath,
  systemsImportRuns: IMPLEMENTED_ROUTES[23].honoPath,
  systemsImportRun: IMPLEMENTED_ROUTES[24].honoPath,
} as const;
