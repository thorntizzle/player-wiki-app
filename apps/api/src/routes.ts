...
export const IMPLEMENTED_ROUTES: ImplementedRoute[] = [
  ...
  {
    method: "GET",
    honoPath: "/campaigns/:campaignSlug/global-search",
    snapshotFamily: "flask",
    snapshotPath: "/campaigns/<campaign_slug>/global-search",
    seedPath: "/campaigns/<campaign_slug>/global-search",
    routeFamily: "browser_json_compatibility",
    missingResource: {
      method: "GET",
      path: "/campaigns/definitely-not-a-campaign/global-search",
      status: 404,
      contentType: "application/json",
      errorCode: "campaign_not_found",
    },
  ...
  {
    method: "GET",
    honoPath: "/campaigns/:campaignSlug/global-search/preview",
    snapshotFamily: "flask",
    snapshotPath: "/campaigns/<campaign_slug>/global-search/preview",
    seedPath: "/campaigns/<campaign_slug>/global-search/preview",
    routeFamily: "browser_json_compatibility",
    missingResource: {
      method: "GET",
      path: "/campaigns/definitely-not-a-campaign/global-search/preview",
      status: 404,
      contentType: "application/json",
      errorCode: "campaign_not_found",
    },
  ...
  {
    method: "GET",
    honoPath: "/campaigns/:campaignSlug/session/wiki-lookup/search",
    snapshotFamily: "flask",
    snapshotPath: "/campaigns/<campaign_slug>/session/wiki-lookup/search",
    seedPath: "/campaigns/<campaign_slug>/session/wiki-lookup/search",
    routeFamily: "browser_json_compatibility",
    missingResource: {
      method: "GET",
      path: "/campaigns/definitely-not-a-campaign/session/wiki-lookup/search",
      status: 404,
      contentType: "application/json",
      errorCode: "campaign_not_found",
    },
  ...
  {
    method: "GET",
    honoPath: "/campaigns/:campaignSlug/session/wiki-lookup/preview",
    snapshotFamily: "flask",
    snapshotPath: "/campaigns/<campaign_slug>/session/wiki-lookup/preview",
    seedPath: "/campaigns/<campaign_slug>/session/wiki-lookup/preview",
    routeFamily: "browser_json_compatibility",
    missingResource: {
      method: "GET",
      path: "/campaigns/definitely-not-a-campaign/session/wiki-lookup/preview",
      status: 404,
      contentType: "application/json",
      errorCode: "campaign_not_found",
    },
...
export const ROUTES = {
  ...
  characterCultivation: IMPLEMENTED_ROUTES[134].honoPath,
  characterRetrainingSubmit: IMPLEMENTED_ROUTES[136].honoPath,
  characterLevelUpSubmit: IMPLEMENTED_ROUTES[137].honoPath,
  characterProgressionRepairSubmit: IMPLEMENTED_ROUTES[138].honoPath,
  campaignGlobalSearch: IMPLEMENTED_ROUTES[139].honoPath,
