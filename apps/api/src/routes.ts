...
export const ROUTES = {
  ...
  campaignList: IMPLEMENTED_ROUTES[17].honoPath,
  appState: IMPLEMENTED_ROUTES[18].honoPath,
  systemsImportRuns: IMPLEMENTED_ROUTES[19].honoPath,
  systemsImportRun: IMPLEMENTED_ROUTES[20].honoPath,
} as const;
