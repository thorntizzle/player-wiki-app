...
export const ROUTES = {
  ...
  systemsSources: IMPLEMENTED_ROUTES[14].honoPath,
  systemsSourceDetail: IMPLEMENTED_ROUTES[15].honoPath,
  systemsSourceCategory: IMPLEMENTED_ROUTES[16].honoPath,
  systemsEntryDetail: IMPLEMENTED_ROUTES[17].honoPath,
  campaignList: IMPLEMENTED_ROUTES[18].honoPath,
  appState: IMPLEMENTED_ROUTES[19].honoPath,
  systemsImportRuns: IMPLEMENTED_ROUTES[20].honoPath,
  systemsImportRun: IMPLEMENTED_ROUTES[21].honoPath,
} as const;
