...
const DEFAULT_CAMPAIGNS_DIR = path.resolve(PROJECT_ROOT, "tests", "fixtures", "sample_campaigns");
...
function resolveBuildId(gitSha, gitDirty) {
...
function buildAppMetadata(environment) {
