...
def test_transport_has_exact_dependency_registration_and_composition_shape() -> None:
    ...
    assert len(route_decorators) == 36
    ...
    assert isinstance(create_app.body[289], ast.FunctionDef)
    assert create_app.body[289].name == "character_session_xianxia_inventory_add"
