...
- Gen2 now has JSON-backed native character create/import lanes for DND-5E creation, Xianxia creation, and Xianxia manual existing-character import, plus a DND-5E Advanced Editor route that reuses the existing native edit derivation path; Cultivation, level-up, retraining, and progression repair still fall back to Flask until those parity slices land
